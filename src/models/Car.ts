...
export interface ICarRaw {
  ...
  color: string;
  status: 'In Stock' | 'Under Repair' | 'Reserved' | 'On Installment' | 'Sold' | 'Rented' | 'Defaulted' | 'Handed';
  images: string[];
  documents: string[];
  notes: string;
...
const CarSchema = new Schema(
  {
    ...
    status: {
      type: String,
      enum: ['In Stock', 'Under Repair', 'Reserved', 'On Installment', 'Sold', 'Rented', 'Defaulted', 'Handed'],
      default: 'In Stock',
    },
    images: [{ type: String }],
