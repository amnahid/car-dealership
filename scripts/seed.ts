...
async function main() {
  ...
  const cars = [
    { _id: car1Id,  carId: 'CAR-001', brand: 'Toyota',    model: 'Camry',    year: 2023, chassisNumber: 'JT2BF1FK0P0001001', engineNumber: '2GRFE001', color: 'White',      status: 'In Stock',    totalRepairCost: 1700, createdBy: adminId },
    { _id: car2Id,  carId: 'CAR-002', brand: 'BMW',       model: '520i',     year: 2023, chassisNumber: 'WBA5A5C51KA001002', engineNumber: 'B48A002', color: 'Black',      status: 'In Stock',    totalRepairCost: 0,    createdBy: adminId },
    { _id: car3Id,  carId: 'CAR-003', brand: 'Audi',      model: 'A6',       year: 2022, chassisNumber: 'WAUZZZ4G1KN001003', engineNumber: 'CYPA003', color: 'Silver',     status: 'In Stock',    totalRepairCost: 3000, createdBy: adminId },
    { _id: car4Id,  carId: 'CAR-004', brand: 'Hyundai',   model: 'Sonata',   year: 2024, chassisNumber: '5NPE24AA1KH001004', engineNumber: 'G4NA004', color: 'Pearl White', status: 'In Stock',   totalRepairCost: 0,    createdBy: adminId },
    { _id: car5Id,  carId: 'CAR-005', brand: 'Kia',       model: 'Optima',   year: 2023, chassisNumber: '5XXGN4A7XDG001005', engineNumber: 'G4KD005', color: 'Blue',       status: 'In Stock',    totalRepairCost: 0,    createdBy: adminId },
    { _id: car6Id,  carId: 'CAR-006', brand: 'Chevrolet', model: 'Malibu',   year: 2021, chassisNumber: '1G1ZB5ST5JF001006', engineNumber: 'LTG006',  color: 'Gray',       status: 'Under Repair', totalRepairCost: 0,   createdBy: adminId },
    { _id: car7Id,  carId: 'CAR-007', brand: 'Ford',      model: 'Mustang',  year: 2022, chassisNumber: '1FA6P8TH3J5001007', engineNumber: 'VOODOO007', color: 'Red',     status: 'Under Repair', totalRepairCost: 0,   createdBy: adminId },
    { _id: car8Id,  carId: 'CAR-008', brand: 'Nissan',    model: 'Patrol',   year: 2024, chassisNumber: 'JN1TANS61Z0001008', engineNumber: 'VK56008', color: 'White',      status: 'Reserved',    totalRepairCost: 0,    createdBy: adminId },
    { _id: car9Id,  carId: 'CAR-009', brand: 'Toyota',    model: 'Corolla',  year: 2022, chassisNumber: '2T1BURHEXKC001009', engineNumber: '2ZRFE009', color: 'Silver',    status: 'Sold',        totalRepairCost: 0,    createdBy: adminId },
    { _id: car10Id, carId: 'CAR-010', brand: 'BMW',       model: '320i',     year: 2023, chassisNumber: 'WBA5A5C55KA001010', engineNumber: 'B48B010', color: 'Black',      status: 'Sold',        totalRepairCost: 0,    createdBy: adminId },
    { _id: car11Id, carId: 'CAR-011', brand: 'Audi',      model: 'Q5',       year: 2023, chassisNumber: 'WA1BNAFY4K2001011', engineNumber: 'DETA011', color: 'Gray',       status: 'Sold',        totalRepairCost: 0,    createdBy: adminId },
    { _id: car12Id, carId: 'CAR-012', brand: 'Hyundai',   model: 'Elantra',  year: 2023, chassisNumber: 'KMHD04LA5KU001012', engineNumber: 'G4FG012', color: 'Blue',       status: 'Sold',        totalRepairCost: 0,    createdBy: adminId },
    { _id: car13Id, carId: 'CAR-013', brand: 'Mercedes',  model: 'C200',     year: 2022, chassisNumber: 'WDD2050032A001013', engineNumber: 'M274013', color: 'White',      status: 'Sold',        totalRepairCost: 0,    createdBy: adminId },
    { _id: car14Id, carId: 'CAR-014', brand: 'Toyota',    model: 'RAV4',     year: 2024, chassisNumber: '2T3RFREV0LW001014', engineNumber: 'A25014',  color: 'Silver',     status: 'Rented',      totalRepairCost: 0,    createdBy: adminId },
    { _id: car15Id, carId: 'CAR-015', brand: 'Kia',       model: 'Sportage', year: 2023, chassisNumber: 'KNDPCCAC6H7001015', engineNumber: 'G4FJ015', color: 'White',      status: 'In Stock',    totalRepairCost: 0,    createdBy: adminId },
  ];
